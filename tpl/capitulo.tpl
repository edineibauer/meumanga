{foreach item=cap key=i from=$data}
    <div class="col color-hover-grey-light manga-episodio">
        <a href="{$home}leitor/{$cap.id}" class="col left" style="width: 80px">
        ...
        <div class="col right color-text-grey font-large padding-16" style="width: 95px">
            <a href="{$home}leitor/{$cap.id}" class="btn margin-0 color-white color-border-green hover-shadow opacity hover-opacity-off"><i class="material-icons left padding-right">chrome_reader_mode</i> ler</a>
        </div>
